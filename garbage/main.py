...
def clear_log(day_log):
    ...
    # 去掉时间特征
    cleared_day_log = cleared_day_log[2:]
    ...
    #['GX0_USG0_0', '0SEC_0_POLICYDENY_l', 'protocol_0', 'source_ip_0_0_0_0', 'source_port_0', 'destination_ip_0_0_0_0', 'destination_port_0', 'interzone_untrust_public__trust_public__inbound', 'policy_0']
    #exit()
